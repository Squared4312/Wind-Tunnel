...
public class AboutMenu implements Menu {
    ...
    public void render(ShapeRenderer sr, SpriteBatch batch) {
        ...
        batch.begin();
            ...
            util.renderText(batch, "as an A-Level Computer Science NEA project.", Color.WHITE, util.getScreenDimensions().x/2, 800, 32, "centre");
            ...
            util.renderText(batch, "Lattice Boltzmann method to simulate a fluid flowing around an object", Color.WHITE, util.getScreenDimensions().x/2, 650, 32, "centre");
